...
int main(){
  ...
  uint32_t shad = create_shader("shaders/vertex.c", "shaders/fragment.c");
  uint32_t game_shader = create_shader("shaders/gamev.c", "shaders/gamef.c");
  ...
  unsigned int button_text = load_texture("res/images/play.png");
  //texture for the title
  unsigned int title_text = load_texture("res/images/title.png");
